...
from tkinter import *
                ...
                # draw.rectangle([BobberX, BobberY, BobberX+BobberWidth, BobberY+BobberHeight], outline="red", width=5)
...
DisplayTooltip(totalCasts, DragonfinCaught, MusselbackCaught, PygmyCaught, TimeElapsed, CatchAdjustment)
